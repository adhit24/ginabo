...
INSERT INTO public.payments (
    id, order_id,
    provider, invoice_number, provider_transaction_id,
    gross_amount, currency,
    payment_type, status,
    created_at, updated_at
) VALUES
('10000000-0000-0000-0000-000000000001','e1000000-0000-0000-0000-000000000001','doku','GNB-20260528-0001','TXN-28052026-001',230000,'IDR','bank_transfer','success',now()-INTERVAL'34 days',now()-INTERVAL'34 days'),
('10000000-0000-0000-0000-000000000002','e1000000-0000-0000-0000-000000000002','doku','GNB-20260530-0001','TXN-30052026-002',333000,'IDR','gopay','success',now()-INTERVAL'32 days',now()-INTERVAL'32 days'),
('10000000-0000-0000-0000-000000000003','e1000000-0000-0000-0000-000000000003','doku','GNB-20260601-0001','TXN-01062026-003',237000,'IDR','qris','success',now()-INTERVAL'30 days',now()-INTERVAL'30 days'),
('10000000-0000-0000-0000-000000000004','e1000000-0000-0000-0000-000000000004','doku','GNB-20260602-0001','TXN-02062026-004',322000,'IDR','bank_transfer','success',now()-INTERVAL'28 days',now()-INTERVAL'28 days'),
('10000000-0000-0000-0000-000000000005','e1000000-0000-0000-0000-000000000005','doku','GNB-20260604-0001','TXN-04062026-005',266000,'IDR','shopeepay','success',now()-INTERVAL'26 days',now()-INTERVAL'26 days'),
('10000000-0000-0000-0000-000000000006','e1000000-0000-0000-0000-000000000006','doku','GNB-20260606-0001','TXN-06062026-006',252000,'IDR','qris','success',now()-INTERVAL'24 days',now()-INTERVAL'24 days'),
('10000000-0000-0000-0000-000000000007','e1000000-0000-0000-0000-000000000007','doku','GNB-20260608-0001','TXN-08062026-007',402000,'IDR','gopay','success',now()-INTERVAL'22 days',now()-INTERVAL'22 days'),
('10000000-0000-0000-0000-000000000008','e1000000-0000-0000-0000-000000000008','doku','GNB-20260610-0001','TXN-10062026-008',347000,'IDR','bank_transfer','success',now()-INTERVAL'20 days',now()-INTERVAL'20 days'),
('10000000-0000-0000-0000-000000000009','e1000000-0000-0000-0000-000000000009','doku','GNB-20260611-0001','TXN-11062026-009',324000,'IDR','qris','success',now()-INTERVAL'14 days',now()-INTERVAL'14 days'),
('10000000-0000-0000-0000-000000000010','e1000000-0000-0000-0000-000000000010','doku','GNB-20260612-0001','TXN-12062026-010',157000,'IDR','bank_transfer','success',now()-INTERVAL'12 days',now()-INTERVAL'12 days'),
('10000000-0000-0000-0000-000000000011','e1000000-0000-0000-0000-000000000011','doku','GNB-20260613-0001','TXN-13062026-011',489000,'IDR','gopay','success',now()-INTERVAL'10 days',now()-INTERVAL'10 days'),
('10000000-0000-0000-0000-000000000012','e1000000-0000-0000-0000-000000000012','doku','GNB-20260613-0002','TXN-13062026-012',237000,'IDR','shopeepay','success',now()-INTERVAL'9 days',now()-INTERVAL'9 days'),
('10000000-0000-0000-0000-000000000013','e1000000-0000-0000-0000-000000000013','doku','GNB-20260614-0001','TXN-14062026-013',303000,'IDR','qris','success',now()-INTERVAL'7 days',now()-INTERVAL'7 days'),
('10000000-0000-0000-0000-000000000014','e1000000-0000-0000-0000-000000000014','doku','GNB-20260614-0002','TXN-14062026-014',239000,'IDR','bank_transfer','success',now()-INTERVAL'5 days',now()-INTERVAL'5 days'),
('10000000-0000-0000-0000-000000000015','e1000000-0000-0000-0000-000000000015','doku','GNB-20260614-0003','TXN-14062026-015',320000,'IDR','gopay','success',now()-INTERVAL'4 days',now()-INTERVAL'4 days'),
('10000000-0000-0000-0000-000000000016','e1000000-0000-0000-0000-000000000016','doku','GNB-20260615-0001','TXN-15062026-016',277000,'IDR','qris','success',now()-INTERVAL'3 days',now()-INTERVAL'3 days'),
('10000000-0000-0000-0000-000000000017','e1000000-0000-0000-0000-000000000017','doku','GNB-20260615-0002','TXN-15062026-017',320000,'IDR','bank_transfer','success',now()-INTERVAL'2 days',now()-INTERVAL'2 days'),
('10000000-0000-0000-0000-000000000018','e1000000-0000-0000-0000-000000000018','doku','GNB-20260615-0003','TXN-15062026-018',520000,'IDR','gopay','success',now()-INTERVAL'36 hours',now()-INTERVAL'36 hours'),
('10000000-0000-0000-0000-000000000019','e1000000-0000-0000-0000-000000000019','doku','GNB-20260615-0004','TXN-15062026-019',202000,'IDR','shopeepay','success',now()-INTERVAL'28 hours',now()-INTERVAL'28 hours'),
('10000000-0000-0000-0000-000000000020','e1000000-0000-0000-0000-000000000020','doku','GNB-20260615-0005','TXN-15062026-020',333000,'IDR','qris','success',now()-INTERVAL'18 hours',now()-INTERVAL'18 hours'),
('10000000-0000-0000-0000-000000000021','e1000000-0000-0000-0000-000000000021','doku','GNB-20260616-0001','TXN-16062026-021',171000,'IDR','bank_transfer','success',now()-INTERVAL'8 hours',now()-INTERVAL'8 hours'),
('10000000-0000-0000-0000-000000000022','e1000000-0000-0000-0000-000000000022','doku','GNB-20260616-0002','TXN-16062026-022',321000,'IDR','gopay','success',now()-INTERVAL'5 hours',now()-INTERVAL'5 hours'),
('10000000-0000-0000-0000-000000000023','e1000000-0000-0000-0000-000000000023','doku','GNB-20260616-0003','TXN-16062026-023',294000,'IDR','qris','success',now()-INTERVAL'2 hours',now()-INTERVAL'2 hours')
ON CONFLICT (id) DO NOTHING;

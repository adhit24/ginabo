INSERT OR IGNORE INTO Product (id, slug, name, description, priceMinor, currency, stockQty, weightGrams, isActive) VALUES
  ('demo_prod_serum_1',  'glowage-multi-active-serum',  'GlowAge Multi-Active Serum',  'Serum ringan untuk membantu kulit tampak lebih cerah alami, halus, dan tetap nyaman di tengah aktivitas harian.', 285000, 'IDR', 50, 20, 1),
  ('demo_prod_cream_1',  'bright-care-moisture-cream',  'Bright & Care Moisture Cream', 'Moisture cream untuk membantu menjaga skin barrier dan menutrisi kulit agar terasa lebih lembap dan tenang.',      195000, 'IDR', 60, 10, 1),
  ('demo_prod_dna_1',   'hydra-moist-gel-ultimate',    'Hydra Moist Gel Ultimate',    'Gel hydration 3-in-1 untuk membantu melembapkan, menenangkan, dan mendukung recovery saat kulit terasa capek.',     215000, 'IDR', 40, 30, 1),
  ('demo_prod_bundle_1','daily-barrier-routine-set',   'Daily Skin Nutrition Set',    'Paket Bright & Care dan Hydra Moist untuk rutinitas AM/PM yang praktis.',                                       620000, 'IDR', 30, 40, 1),

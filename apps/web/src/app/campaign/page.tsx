...
const campaigns = [
  {
    ...
    badgeColor: "#2a7c78",
    title: "Ginabo Partner Program",
    tagline: "Jual lebih mudah, sistem lebih jelas.",
    desc: "Program kemitraan resmi untuk partner, stockist, dan distributor. Dibangun dengan sistem distribusi yang sehat, terarah, dan berkelanjutan.",
    perks: [
      "Margin lebar dengan harga khusus partner",
      "Reward penjualan lewat challenge & insentif",
      "Bimbingan & training product knowledge + basic selling",
      "Free sample & support tools untuk trial harian",
    ],
    cta: "Gabung Sekarang",
    href: "/reseller",

      ...
      <section aria-label="Hero" className="relative w-full overflow-hidden">
        ...
        <div className="relative w-full" style={{ aspectRatio: "1280/430" }}>
          ...
          <motion.a
            ...
            className="absolute bottom-[3%] left-[3%] w-[30%] min-w-[140px] max-w-[420px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#78257C]"

...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans:        ["var(--font-jakarta)", "var(--font-outfit)", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "Roboto", "sans-serif"],
        futura:      ["var(--font-outfit)", "var(--font-jakarta)", "-apple-system", "BlinkMacSystemFont", "sans-serif"],
